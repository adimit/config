...
#+begin_src emacs-lisp
  ...
  (evil-leader/set-key "eo" '(lambda () (interactive) (find-file "~/doc/org/main.org")))
#+end_src
...
#+begin_src emacs-lisp
  (winner-mode 1)
  (evil-leader/set-key "wh" 'winner-undo)
  (evil-leader/set-key "wl" 'winner-redo)
#+end_src
...
*** Key bindings
#+begin_src emacs-lisp
  (evil-leader/set-key-for-mode 'org-mode "oe" 'org-export-dispatch)
#+end_src
...
#+begin_src emacs-lisp
  (setq org-latex-default-packages-alist
        '(("" "fontspec" t)
          ...
          "\\tolerance=1000"
          ("" "polyglossia")
          ; there's a bug in polyglossia that makes \sffamily fragile.
          ; See https://github.com/reutenauer/polyglossia/issues/90
...
* Languages
** Haskell-built tools
   Add tools built by Haskell into the executable paths. (Needed by Elm and Haskell.)
#+begin_src emacs-lisp
  (add-to-list 'exec-path "~/.cabal/bin/")
  (add-to-list 'exec-path "~/local/haskell/bin")
...
#+begin_src emacs-lisp
  (defun org-mode-reftex-keybindings-setup ()
    ...
    (evil-leader/set-key-for-mode 'org-mode "o" 'org-reftex-citation)
...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-mode-hook 'org-mode-reftex-keybindings-setup)
#+end_src
...
*** Keyboard Setup
#+begin_src emacs-lisp
  (evil-leader/set-key-for-mode 'lisp-interaction-mode "j" 'eval-last-sexp)
#+end_src
*** Hooks
#+begin_src emacs-lisp
