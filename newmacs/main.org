...
#+begin_src emacs-lisp
  (defun aleks/set-light-mode-faces ()
    ...
    (custom-set-faces
     '(variable-pitch ((t (:family "Bitter" :height 140))))
...
#+begin_src emacs-lisp
  (use-package centaur-tabs
    :general (:states 'normal :prefix "g"
                      "p" 'centaur-tabs-toggle-groups
    ...
    :config
    (centaur-tabs-change-fonts "Bitter" 120))

  ; for some reason, use-package doesn't switch on centaur-tabs mode properly
  (centaur-tabs-mode 1)
#+end_src
** Company
...
Sadly, =eslint= server needs to be installed separately. Use

#+begin_src shell
  git clone https://github.com/Microsoft/vscode-eslint -b 'release/2.0.9'
  cd vscode-eslint
  npm install && npm run compile
#+end_src

The current upstream version [[https://github.com/emacs-lsp/lsp-mode/issues/1932][does not work with lsp-mode]], which is why we checkout =2.0.9=.

#+begin_src emacs-lisp
  (custom-set-variables
   '(lsp-eslint-server-command
     '("node"
       "/home/aleks/var/src/vscode-eslint/server/out/eslintServer.js"
       "--stdio")))
#+end_src
    ...
    (org-agenda-custom-commands
     '(("R" "Weekly Review"
        ((todo "TODO" ((org-agenda-overriding-header "Unfinished")
         ...
         (todo "PLAN" ((org-agenda-overriding-header "Planned")
                       (org-agenda-files `(,my-org-main-file))))
...
#+BEGIN_SRC emacs-lisp
  (customize-set-variable 'org-capture-templates
        '(("k" "Add to stack" entry (file+headline my-org-main-file "Stack")
           "* PLAN %^{Title}\n:PROPERTIES:\n:CREATED: %U\n:END:\n%?")
