...
#+begin_src emacs-lisp
  ...
  (defun aleks/set-custom-faces ()
    "Set the faces we care about."
...
#+begin_src emacs-lisp
  (custom-set-faces
   '(variable-pitch ((t (:family "Bitstream Charter" :height (lambda (height) (truncate (* height (/ 6 5.0))))))))
   '(fixed-pitch ((t (:family "Fira Code" :height (lambda (height) (truncate (* height (/ 5 6.0))))))))
...
Enable flyspell mode and visual line mode in all text mode buffers
...
Add nice icons in the company popup.
#+begin_src emacs-lisp
