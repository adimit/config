...
#+END_SRC
*** TODO Keybindings
I'll have to remove hydra and add [[https://github.com/noctuid/general.el][general]]. Together with which-key it
seems to provide what I want in a much better form.
