...
(add-hook 'after-init-hook 'aleks/set-light-mode-faces)
#+end_src
...
(transient-define-prefix dispatch-space-menu () "This isn't documentation."
  [[
   ...
   ["Org"
    ...
    ("o c o" "org clock out" org-clock-out)
    ("o c g" "org clock goto" org-clock-goto)
    ("o c i" "org clock in" org-clock-in)
    ("o c c" "org capture" org-capture)]
   ["Git"
