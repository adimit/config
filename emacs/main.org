...
*** TODO Fix delete keybinding
Meow's default is terrible. It should work like in Helix.
...
*** TODO Add search keybindings
Maybe just use isearch, and but bind it to =/= and =?=
*** TODO Add surround add
*** TODO Add surround replace
*** TODO Add surround delete
*** TODO Add surround around object
*** TODO Add surround inside object
*** TODO Paren slurp/barf keybindings
