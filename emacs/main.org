...
*** TODO Create paste bindings for  =p= and =P=
...
But the default action is append-paste (yank, whatever), i.e. paste below, or after the current cursor.
